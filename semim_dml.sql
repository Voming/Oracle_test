...
--대댓글 (5번글에)
UPDATE BOARD_REPLY SET BOARD_REPLY_STEP = BOARD_REPLY_STEP + 1 
    WHERE BOARD_REPLY_STEP > (SELECT BOARD_REPLY_STEP FROM BOARD_REPLY WHERE BOARD_REPLY_ID = 5);
...
--대댓글 (4번글에)
UPDATE BOARD_REPLY SET BOARD_REPLY_STEP = BOARD_REPLY_STEP + 1 
    WHERE BOARD_REPLY_STEP > (SELECT BOARD_REPLY_STEP FROM BOARD_REPLY WHERE BOARD_REPLY_ID = 4);
        
INSERT INTO BOARD_REPLY VALUES( 
    (SELECT NVL(MAX(BOARD_REPLY_ID),0)+1 FROM BOARD_REPLY), 5,
    'kh1', '4번대댓글1', default, null, 
